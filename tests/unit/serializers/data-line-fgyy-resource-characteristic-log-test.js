...
moduleForModel('data-line-fgyy-resource-characteristic-log', 'Unit | Serializer | data-line-fgyy-resource-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-fgyy-resource-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
