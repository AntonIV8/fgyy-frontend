...
moduleForModel('data-line-fgyy-service-characteristic', 'Unit | Serializer | data-line-fgyy-service-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-fgyy-service-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
