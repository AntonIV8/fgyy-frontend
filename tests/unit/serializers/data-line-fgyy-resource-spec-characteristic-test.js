...
moduleForModel('data-line-fgyy-resource-spec-characteristic', 'Unit | Serializer | data-line-fgyy-resource-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-fgyy-resource-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
