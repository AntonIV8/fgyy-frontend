...
moduleForModel('data-line-fgyy-resource-characteristic', 'Unit | Serializer | data-line-fgyy-resource-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-fgyy-resource-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
